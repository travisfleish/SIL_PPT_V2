...
class TeamConfigManager:
    ...
    def get_view_name(self, team_key: str, view_type: str) -> str:
        ...
        Args:
            ...
            view_type: e.g., 'community_all_time', 'merchant_yoy'

        Returns:
            Full view name, e.g., 'V_UTAH_JAZZ_SIL_COMMUNITY_INDEXING_ALL_TIME'
        """
        ...
        # Special case: Utah Jazz demographics has double "SIL"
        if team_key == 'utah_jazz' and view_type == 'demographics':
            view_name = view_name.replace('_DEMOGRAPHICS_DIST', '_SIL_DEMOGRAPHICS_DIST')
